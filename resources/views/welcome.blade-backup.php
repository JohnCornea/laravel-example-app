...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        {{-- <h1>Homepage is this! Also profil too! ++ CATEGORIES </h1> --}}
        <h2>Store method</h2>
        ...
        <hr>
        <h2>Categories Update Method</h2>
        ...
        <script>
        // Harder way to submit request via JQUERY
        ...
        // EASIEST WAY TO SUBMIT REQUESTS VIA JS AXIOS
        function submitForm(e) {
            e.preventDefault();

            axios.post('/posts', {}).then(function (data) { 
                console.log(data);
             })
        }
